...
function HeroSection() {
  return (
    ...
    <Image src="https://res.cloudinary.com/dkeh0cumc/image/upload/v1754926933/Line_rjqzxi.png" alt="hero" width={1000} height={1000} className="w-full h-full object-cover absolute top-0 left-0 z-0" />
