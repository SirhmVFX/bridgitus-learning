...
function Why() {
  ...
  return (
    <section className="bg-gradient-to-b from-black/5 to-black/2 ">
      <div className="md:w-[1200px] md:mx-auto flex flex-col gap-10 py-20 px-4 md:px-0">

        <div className="flex flex-col gap-4 items-center">
          <h1 className="md:w-2/3 md:text-center md:text-5xl text-4xl">Here&apos;s why you should choose Bridgitus Learning </h1>
          <p className="md:w-2/3 md:text-center md:text-sm text-xs text-black/50">These are the reasons why past sponsors have been a part of what we do at Bridgitus Learning and it&apos;s and it&apos;s the reasosn why they are still contributing </p>
        </div>
        
        <div className="bg-white rounded-xl  hover:scale-105 cursor-pointer transition-all flex md:flex-row flex-col items-end gap-10">
          <div className="flex flex-col items-start gap-6 md:w-1/2  md:p-16 p-6">
            <h1 className="md:text-4xl text-2xl md:leading-none leading-6">
            Personalized <span className="text-blue-500 font-bold">One-on-One</span> Tutoring
            </h1>
            <p>Unlock your child’s full potential with tailored learning experiences</p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { id: 1, title: "Struggling to grasp complex subjects in school" },
                { id: 2, title: "Lack of individual attention in traditional classrooms" },
                { id: 3, title: "Difficulty staying focused during online learning" },
                { id: 4, title: "Inconsistent academic progress and low confidence" },
                { id: 5, title: "Limited resources for targeted academic support" },
              ].map((e) => (
                <div key={e.id} className="flex items-center gap-2">
                    <Check />
                  <p className="text-xs text-black/50">{e.title}</p>
                </div>
              ))}
            </div>
          </div>
          <div className="md:w-1/2 p-8 pb-0">
            <Image width={1000} height={1000} src="/assets/ptp.svg" alt="why" className="w-full h-full object-cover" />
          </div>
        </div>
        ...
        <div className="md:w-1/2 bg-blue-500 text-white rounded-xl  hover:scale-105 cursor-pointer transition-all">
          <div className="flex flex-col items-start gap-6 md:p-16 md:pb-0 p-6">
            <h1 className="md:text-4xl text-2xl md:leading-none leading-6">
            Collaborative <span className="font-bold text-yellow-400">Group Learning</span>
            </h1>
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                { id: 1, title: "Isolation in traditional online learning environments" },
                { id: 2, title: "Limited opportunities for collaborative problem-solving" },
          ...
          <div>
            <Image src="/assets/cgl.svg" alt="cgl" width={1000} height={1000} />
          </div>
        </div>
        ...
        <div className="md:w-1/2 bg-black rounded-xl  hover:scale-105 cursor-pointer transition-all text-white">
          <div className="flex flex-col items-start gap-6 md:p-16 p-6">
            <h1 className="md:text-4xl text-2xl md:leading-none leading-6">
            <span className="font-bold text-green-500">Academic Success</span> Support
            </h1>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { id: 2, title: "Unfinished or incorrect homework assignments" },
                { id: 3, title: "Ineffective study strategies and time management" },
                { id: 4, title: "Struggling to balance multiple subjects and deadlines" },
                { id: 5, title: "Difficulty applying classroom knowledge to real-world scenarios" },
              ].map((e) => (
                <div key={e.id} className="flex items-center gap-2">
                    <Check />
                  <p className="text-xs">{e.title}</p>
          ...
          <div>
            <Image src="/assets/acs.svg" alt="academic" width={1000} height={1000} />
          </div>
        </div>
        </div>
      </div>
