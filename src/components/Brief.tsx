...
function Brief() {
  return (
    <section className="bg-gradient-to-b from-black to-black/20 md:h-[calc(100vh-200px)] h-fit flex items-center md:pb-0 pb-36">
      <div className="md:w-[1200px] md:mx-auto flex md:flex-row flex-col-reverse justify-between gap-20 items-center px-4 md:px-0">
        ...
        <div className="md:w-1/2 flex flex-col gap-8 items-start">
          <h1 className="text-white md:text-5xl text-3xl italic">
            “Let your passion for learning be louder than your doubts, your dreams brighter than your fears, and your determinations stronger than your excuses.”
          </h1>
          <div className="flex md:gap-5 gap-2 items-center">
            <div className="w-12 h-14 ">
              <Image width={1000} height={1000} src="/assets/phemmie.png" alt="founder" className="w-full h-full object-cover" />
            </div>
            <div>
              <h1 className="text-white md:text-2xl text-xl">Phemmie Olugbogi</h1>
              <p className="text-white/50 md:text-sm text-xs">Founder, Bridgitus Learning</p>
            </div>
          </div>
        </div>
      </div>
