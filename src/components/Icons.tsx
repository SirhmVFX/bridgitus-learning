...
export const Phone = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="text-white lucide lucide-phone-icon lucide-phone"
    >
...
export const Star = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="text-white lucide lucide-star-icon lucide-star"
    >
...
export const Star2 = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="text-amber-500 lucide lucide-star-icon lucide-star"
    >
      <path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z" />
    </svg>
  );
...
export const Mail = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="text-white lucide lucide-mail-icon lucide-mail"
    >
...
export const Verified = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="text-white lucide lucide-badge-check-icon lucide-badge-check"
    >
...
export const Facebook = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="text-white lucide lucide-facebook-icon lucide-facebook"
    >
...
export const Instagram = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="text-white lucide lucide-instagram-icon lucide-instagram"
    >
...
export const Youtube = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="text-white lucide lucide-youtube-icon lucide-youtube"
    >
...
export const Linkedin = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="text-white lucide lucide-linkedin-icon lucide-linkedin"
    >
...
export const ArrowRightUp = ({ className }: { className?: string }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`${className} lucide lucide-move-up-right-icon lucide-move-up-right`}
    >
      <path d="M13 5H19V11" />
      <path d="M19 5L5 19" />
    </svg>
...
export const Ico = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="lucide lucide-cannabis-icon lucide-cannabis"
    >
      <path d="M12 22v-4" />
...
export const Schedule = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="text-blue-500 lucide lucide-calendar-check2-icon lucide-calendar-check-2"
    >
      <path d="M8 2v4" />
      <path d="M16 2v4" />
...
export const Commit = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="text-green-500 lucide lucide-git-graph-icon lucide-git-graph"
    >
...
export const Trial = () => {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="text-pink-500 lucide lucide-waypoints-icon lucide-waypoints"
    >
